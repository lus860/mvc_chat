...
<button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fad fa-arrow-to-top"></i></button>
<!-- loader  -->
<div class="loader_bg">
                                        ...
                                        <div class="btn-group dropright">
                                            ...
                                            <div id="dropdown-menu" style="display:none!important;" >
                                                <div class="dropdown-menu" >
                                                    <ul id="notification" style="overflow: auto; width:260px; height:150px;font-size: 16px">
    ...
    <script>
        ...
        function notification() {
            ...
            $.ajax({
                ...
                data: formData,
                success: function(d) {
                    var length = d.countAll;
                    $("#not_count").text(length);
                    var li = '';
                    var i;
                    for (i in d) {

                        if(d[i]['first_name'] && d[i]['last_name']) {

                            li = li + '<li style="height: 50px!important;"><a style="padding: 20px;font-size: 12px!important;width: 100%" href='+"message?id="+d[i]['from']+'>'+'<img src=/images/profile/'+d[i]['prof_img'] + ' class="img-circle" alt="Cinque Terre" style="width: 40px;height: 40px!important;"> ' +d[i]['first_name']+' '+d[i]['last_name']+' <span style="color: #9a0000">-'+d[i]['count']+'</span></a> </li>'
